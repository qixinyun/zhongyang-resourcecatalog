...
interface IResourceCatalogTypeName
{
    const TYPE_NAME = array(
        ...
        IResourceCatalog::TYPE['XZQZXX'] => '行政强制',
        IResourceCatalog::TYPE['XZZSXX'] => '行政征收信息',
        IResourceCatalog::TYPE['XZCJXX'] => '行政裁决',
        IResourceCatalog::TYPE['XZQRXX'] => '行政确认',
        IResourceCatalog::TYPE['XZJFXX'] => '行政给付信息',
        IResourceCatalog::TYPE['JDJCXX'] => '行政监督检查',
        IResourceCatalog::TYPE['XZJLXX'] => '行政奖励',
